 ...
 * @file <ark.h>
 *
 * @brief This is the header file of ALF, the ARK (Augmented Reality for Kilobots) loop function. Here, we reproduce
...
private:
    ...
    UInt32 m_unMessagingCounter,m_unDataSavingCounter;
